...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('have url property and it is not empty', function() {
         ...
         */
         it('have name property and it is not empty', function() {
             allFeeds.forEach(function(feed) {
    ...
    describe('The menu', function() {
         ...
         */
         ...
         it('displays when clicked and hides when clicked again', function() {
           $('.menu-icon-link').trigger('click');   // Tigger is used to manually trigger an event
    ...
    describe('New Feed Selection', function() {
        ...
        it('tests whether content actually changes', function(done) {
          expect(feed1).not.toBe(feed2);    // Here both feeds are compared to see if they are different
          done();
        });
    });
}());
